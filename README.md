...
```
0030:xxoQ [23:03:45:045;134.249.152.59;tornado_handler:203]: >> {"action": "deleteRoom", "roomId": 135, "userId": 30, "handler": "channels", "time": 1514322224995}
0030:xxoQ [23:03:45:054;134.249.152.59;tornado_handler:54]: << {"action":"deleteRoom","roomId":135}
0030:xxoQ [23:03:45:056;134.249.152.59;tornado_handler:203]: >> {"action": "growl", "content": "You are not allowed to exit this room", "userId": 30, "time": 1514322225056, "handler": "growl"}
0030:xxoQ [23:03:45:183;134.249.152.59;tornado_handler:54]: << {"action":"deleteRoom","roomId":138}
0030:xxoQ [23:03:45:223;134.249.152.59;message_handler:120]: !! channel 138 redis online: ['0030:xxoQ']
0030:xxoQ [23:03:45:224;134.249.152.59;message_handler:160]: <138> {"action": "removeOnlineUser", "content": [], "userId": 30, "time": 1514322225224, "handler": "chat", "channel": 138, "user": "deathangel9082", "sex": "Secret"}
0030:xxoQ [23:03:45:258;134.249.152.59;message_handler:160]: <138> {"action": "deleteRoom", "roomId": 138, "userId": 30, "handler": "channels", "time": 1514322225258}
0030:xxoQ [23:03:45:285;134.249.152.59;tornado_handler:203]: >> {"action": "removeOnlineUser", "content": [], "userId": 30, "time": 1514322225224, "handler": "chat", "channel": 138, "user": "deathangel9082", "sex": "Secret"}
0030:xxoQ [23:03:45:298;134.249.152.59;tornado_handler:54]: << {"action":"deleteRoom","roomId":138}
0030:xxoQ [23:03:45:319;134.249.152.59;message_handler:120]: !! channel 138 redis online: ['0030:xxoQ']
0030:xxoQ [23:03:45:320;134.249.152.59;message_handler:160]: <138> {"action": "removeOnlineUser", "content": [], "userId": 30, "time": 1514322225320, "handler": "chat", "channel": 138, "user": "deathangel9082", "sex": "Secret"}
0030:xxoQ [23:03:45:350;134.249.152.59;message_handler:160]: <138> {"action": "deleteRoom", "roomId": 138, "userId": 30, "handler": "channels", "time": 1514322225349}
0030:xxoQ [23:03:45:370;134.249.152.59;tornado_handler:203]: >> {"action": "deleteRoom", "roomId": 138, "userId": 30, "handler": "channels", "time": 1514322225258}
0030:xxoQ [23:03:45:395;134.249.152.59;tornado_handler:203]: >> {"action": "removeOnlineUser", "content": [], "userId": 30, "time": 1514322225320, "handler": "chat", "channel": 138, "user": "deathangel9082", "sex": "Secret"}
None [23:03:45:419;None;web:1548]: Uncaught exception GET /?id= (127.0.0.1)
HTTPServerRequest(protocol='https', host='pychat.org', method='GET', uri='/?id=', version='HTTP/1.0', remote_ip='127.0.0.1', headers={'Upgrade': 'websocket', 'Connection': 'upgrade', 'Host': 'pychat.org', 'X-Real-Ip': '134.249.152.59', 'Pragma': 'no-cache', 'Cache-Control': 'no-cache', 'Origin': 'https://pychat.org', 'Sec-Websocket-Version': '13', 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36', 'Accept-Encoding': 'gzip, deflate, br', 'Accept-Language': 'en-US,en;q=0.9,ru;q=0.8', 'Cookie': '__cfduid=d179640f6079fa998891d9129a32e6a891498596351; G_ENABLED_IDPS=google; sessionid=n3b0t6h6qh66eszmd5jxb1jalxeigrf4; csrftoken=XlLNu8u9tI5SzIioFElL3Ii92uzn4p4A', 'Sec-Websocket-Key': 'Lqaev9BeeWU9tFzeC+cZcg==', 'Sec-Websocket-Extensions': 'permessage-deflate; client_max_window_bits'})
Traceback (most recent call last):
  File "/usr/lib/python3.6/site-packages/tornado/web.py", line 1425, in _stack_context_handle_exception
    raise_exc_info((type, value, traceback))
  File "<string>", line 3, in raise_exc_info
  File "/usr/lib/python3.6/site-packages/tornado/stack_context.py", line 314, in wrapped
    ret = fn(*args, **kwargs)
  File "/usr/lib/python3.6/site-packages/tornado/gen.py", line 199, in final_callback
  ...
  File "/usr/lib/python3.6/site-packages/tornadoredis/client.py", line 1164, in listen
    callback(result)
  File "/srv/http/djangochat/chat/tornado/message_handler.py", line 184, in pub_sub_message
    res = self.post_process_message[dict_message[VarNames.EVENT]](dict_message)
  File "/srv/http/djangochat/chat/tornado/message_handler.py", line 290, in send_client_delete_channel
