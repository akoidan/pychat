...
class DjangoView:
	...
	def home(request):
		...
		"""
		return render_to_response('static/story/chat.html', csrf(request),  context_instance=RequestContext(request))
	...
	def confirm_email(request):
		...
		try:
			...
			return render_to_response('static/story/confirm_mail.html', response,  context_instance=RequestContext(request))
	...
	def get_register_page(request):
		...
		return render_to_response("static/story/register.html", c,  context_instance=RequestContext(request))
	...
	def change_profile(request):
		...
		return render_to_response('static/story/change_profile.html', c,  context_instance=RequestContext(request))
	...
	def show_profile(request, profile_id):
		try:
			...
			return render_to_response(
				'static/story/show_profile.html',
				{'form': form},
	...
	def report_issue(request):
		if request.method == 'GET':
			return render_to_response(
				'static/story/issue.html',  # getattr for anonymous.email
	...
	@require_http_methods('GET')
	def hack(request):
		return render_to_response('static/story/')