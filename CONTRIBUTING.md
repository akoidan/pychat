...
Icons
=====
To edit fonts execute `sh download_content.sh fonts_session`. After this open generated url browser, edit everything as you like (you're redirected with a session so every change will be saved in fontello for 24 hours. After you finish download changes with `sh download_content.sh download_fontello`. If you did everything right new icons should appear in [demo.html](https://127.0.0.1:8000/static/demo.html)
