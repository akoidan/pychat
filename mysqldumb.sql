...
DROP TABLE IF EXISTS `story_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `story_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `story_messages_936913d1` (`userid_id`),
  CONSTRAINT `userid_id_refs_id_b5856011` FOREIGN KEY (`userid_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=616 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `story_userprofile`
--

DROP TABLE IF EXISTS `story_userprofile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `story_userprofile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `email_verified` tinyint(1) NOT NULL,
  `verify_code` varchar(17) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `user_id_refs_id_d388b027` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
...
-- Dump completed on 2014-12-21  5:42:11
