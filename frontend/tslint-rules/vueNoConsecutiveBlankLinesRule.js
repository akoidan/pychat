...
var Rule = /** @class */ (function (_super) {
    ...
    Rule.metadata = {
        ruleName: "vue-no-consecutive-blank-lines",
...
function walk(ctx) {
    ...
    var _a = utils.getLineRanges(ctx.sourceFile);
    if (ctx.sourceFile.fileName.endsWith('.vue')) {
        let trimmedSource = sourceText.trimLeft();
        let diff = sourceText.length - trimmedSource.length;
        _a.splice(0, diff)
    }
